...
const DetailProduct = () => {
    ...
    if (!idUser || !product || !relative) return <>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="product__details__text">
                                        ...
                                        {product.quantity == 0 ?
                                            <a className="primary-btn" aria-disabled >Hết Hàng</a>
                                            :
                                            <a onClick={() => onHandleAddProduct()} className="primary-btn">Thêm vào giỏ hàng</a>
                                        }
                                        <ul>
