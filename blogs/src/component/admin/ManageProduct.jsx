...
import { getAllProductByAdmin } from '../../service/Admin';
...
const ManageProduct = () => {
    ...
    //           updatedPage--;
    //         }
    //         const result = await getAllBlog(updatedPage, search);
                                                                    ...
                                                                    products.map((value, index) => (
                                                                        <tr key={value.id}>
                                                                            ...
                                                                            <td className="align-middle text-center">
                                                                                ...
                                                                                <a style={{ padding: '10px' }} className="text-secondary text-xs font-weight-bold  ">Xóa</a>
                                                                            </td>
                                                                        </tr>
                                                                    ))
                                                                }
