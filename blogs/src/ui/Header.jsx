          ...
          <div className="container">
            ...
            <div className="collapse navbar-collapse" id="navbarResponsive">
              <ul className="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                ...
                <li className="nav-item"><p style={{ color: 'black', fontSize: '15px', fontWeight: '600' }} className="nav-link" >{userName}</p></li>
                <li className="nav-item mr-10 ml-10"><img src={image} /></li>
                {role == "ROLE_USER" && (
                  <li className="nav-item">
